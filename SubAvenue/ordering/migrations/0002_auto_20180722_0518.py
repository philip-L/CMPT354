...
class Migration(migrations.Migration):
    ...
    operations = [
    	migrations.RunSQL("INSERT INTO Restaurant (Restaurant , Address ) \
    	...
    	migrations.RunSQL("INSERT INTO Employee (Employee, EmployeeName, EmployeePosition ) \
    	...
    	migrations.RunSQL("INSERT INTO  WorksAt (Restaurant_id, Employee_id ) VALUES  ('R100', 'E100'), ('R101', 'E101'), ('R102', 'E102'), ('R103', 'E103'), ('R104', 'E104');"),

    	migrations.RunSQL("INSERT INTO Customer (Customer , Name , Email , CardNumber , Address , Password ) \
    	...
    	migrations.RunSQL("INSERT INTO  Orders (`Order`, `Restaurant_id`, `Customer_id`, `DeliverySuccess`, `DeliveryInstructions`, `OrderPlacementTime`, `OrderCompletionTime`, `DeliveryOrPickup`) \
    	...
    	migrations.RunSQL("INSERT INTO MenuItem (MenuItem, ItemName, Price) VALUES \
    	...
    	migrations.RunSQL("INSERT INTO Contain (Order_id, MenuItem_id, Quantity) \
    		VALUES  ('O100', 'M100', 1), ('O101', 'M101', 2), ('O102', 'M100', 3), ('O103', 'M102', 1), \
    		('O104', 'M103', 3);"),

    	migrations.RunSQL("INSERT INTO Sandwich (MenuItem_id, SandwichName, SandwichSize ) \
    		VALUES ('M100', 'Chicken Sandwich', 'H'), ('M107', 'Ham and Cheese', 'F'), \
    		('M108', 'Egg Salad Sandwich', 'F'), ('M105', 'Turkey Sandwich', 'H'), \
    		('M104', 'Tuna Sandwich', 'H');"),

    	migrations.RunSQL("INSERT INTO Drinks (MenuItem_id, DrinkName, DrinkSize ) VALUES \
    		('M101', 'Pepsi', 'S'), ('M109', 'Lemonade', 'L'), ('M110', 'IcedTea', 'M'), \
    		('M111', 'Sprite', 'M'), ('M112', 'Coca-Cola', 'S');"),

    	migrations.RunSQL("INSERT INTO Snacks (MenuItem_id, SnackName ) VALUES \
    	...
    	migrations.RunSQL("INSERT INTO Ingredients (Ingredient, IngredientName ) VALUES \
    		('I100', 'Tomato'), ('I101', 'Lettuce'), ('I102', 'Turkey'), ('I103', 'Whole Grain Bread'), \
    		('I104', 'Mayonnaise');"),

    	migrations.RunSQL("INSERT INTO MadeWith (MenuItem_id, Ingredient_id ) VALUES \
